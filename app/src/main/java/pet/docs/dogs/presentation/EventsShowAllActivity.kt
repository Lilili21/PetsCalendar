...
class EventsShowAllActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listViewOfEvents.adapter = SimpleAdapter(this, convertToShowList(eventsList()),R.layout.pattern_show_all_events,
            arrayOf("eventType","comment","date"), intArrayOf(R.id.event_title2, R.id.comment2, R.id.date))
        month.text = "November"

        listViewOfEvents2.adapter = SimpleAdapter(this, convertToShowList(eventsList()),R.layout.pattern_show_all_events,
            arrayOf("eventType","comment","date"), intArrayOf(R.id.event_title2, R.id.comment2, R.id.date))
